...
namespace NetworkOperations
{
    public class BitchuteStuff : IDisposable
    {
        ...
        public BitchuteStuff(string location)
        {
        ...
        public void DoStuff()
        {
            var delayBetweenRequestsSeconds = 5;
            ...
            try
            {
                ...
                ConsoleTs.WriteLine($"{_location}:{request.RequestUri.AbsoluteUri} {response.StatusCode} {responseContent.Length}chars");
            }
            catch { }


            Thread.Sleep(delayBetweenRequestsSeconds * 1000);

            try
            {
                var request = new HttpRequestMessage(new HttpMethod("GET"), "https://www.bitchute.com/video/kIkNTyD5nPdZ/");
                request.Headers.TryAddWithoutValidation("authority", "www.bitchute.com");
                request.Headers.TryAddWithoutValidation("cache-control", "no-store");
                request.Headers.TryAddWithoutValidation("sec-ch-ua", "^^");
                request.Headers.TryAddWithoutValidation("sec-ch-ua-mobile", "?0");
            ...
            try
            {
                var request = new HttpRequestMessage(new HttpMethod("GET"), "https://www.bitchute.com/video/Jlkoz9VOHszb/");
                request.Headers.TryAddWithoutValidation("authority", "www.bitchute.com");
                request.Headers.TryAddWithoutValidation("cache-control", "no-store");
                request.Headers.TryAddWithoutValidation("sec-ch-ua", "^^");
                request.Headers.TryAddWithoutValidation("sec-ch-ua-mobile", "?0");
            ...
            try
            {
                var request = new HttpRequestMessage(new HttpMethod("GET"), "https://www.youtube.com/watch?v=mqL7aE_-naM");
